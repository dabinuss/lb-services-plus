import { CheckCircle2, Clock3, MapPin, Phone, Send, XCircle } from "lucide-react";
...
export function CompanyCard({ company, locale, settings, onCall, onRequest }: Props) {
  const callEnabled = settings.callsEnabled && company.available && Boolean(company.primaryNumber);
