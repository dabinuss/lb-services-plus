...
const ICONS = {
  ...
  carWash: (
    <>
      <path d="M5 16h14v-5a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2z" />
      <circle cx="7.5" cy="18" r="1.3" />
      <circle cx="16.5" cy="18" r="1.3" />
      <path d="M7 2l-1 2l2 2l-1 2" />
      <path d="M12 1l-1 2l2 2l-1 2" />
      <path d="M17 2l-1 2l2 2l-1 2" />
    </>
  ),
  restaurant: (
    <>
  ...
  barber: (
    <>
      ...
      <line x1="8" y1="7.5" x2="20" y2="20" />
      <line x1="8" y1="16.5" x2="20" y2="4" />
    </>
  ),
  tattoo: (
