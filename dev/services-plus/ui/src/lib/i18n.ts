...
const messages = {
  en: {
    ...
    search: "Search companies or categories...", all: "All categories", noServices: "No services found",
    ...
    requestTitle: "New request", details: "What do you need?", location: "Location", sendRequest: "Send request", cancel: "Cancel", confirm: "Confirm",
    ...
    noDispatch: "No dispatcher selected", role: "Role", contactEmployee: "Open employee contact", callEmployee: "Call employee", numberInbox: "Inbox",
    requestNotificationActionable: "Accept/decline in notification", requestNotificationActionableHint: "For time-critical requests (taxi, PD, EMS): the phone notification gets Accept/Decline buttons. Other companies' employees are just informed and have to open the app to act.",
    ...
    unknownNumber: "Unknown number", requestLabel: "Request label", createLabel: "Creation label", templates: "Templates", back: "Back", queuePosition: "Queue position", selectNumber: "Select phone number", sendLocation: "Send current location", locationSent: "Location sent", enabled: "Enabled", required: "Required", categoryCompetition: "Cross-company request competition", categoryCompetitionHint: "Available employees in this category compete for requests", deleteRequest: "Delete request", deleteConversation: "Delete conversation", deleteMessage: "Delete message", public: "Public", numberCapabilitiesHint: "Enabled is the master switch. Public makes the enabled channels visible to citizens; disabling it keeps the internal inbox but hides the number from the directory.", staffedLines: "Staffed lines", navigation: "Navigation on acceptance", navigationDisabled: "Disabled", navigationAsk: "Ask employee", navigationAutomatic: "Automatic", activeRequests: "Active requests", requestHistory: "Request history", allInboxes: "All inboxes",
    noRequestDetails: "No further details submitted", createdAt: "Submitted", navigateToRequest: "Set waypoint",
    statusAccepted: "Accepted", statusReturned: "Returned", statusCancelled: "Cancelled", statusDeleted: "Deleted",
    requestAction: "Request"
  },
  de: {
    directory: "Verzeichnis", activity: "Meine Aktivitäten", portal: "Unternehmensportal", admin: "Administration",
    search: "Unternehmen oder Kategorien suchen...", all: "Alle Kategorien", noServices: "Keine Dienste gefunden",
    ...
    requestTitle: "Neue Anfrage", details: "Was benötigst du?", location: "Standort", sendRequest: "Anfrage senden", cancel: "Abbrechen", confirm: "Bestätigen",
    ...
    noDispatch: "Keine Leitstelle ausgewählt", role: "Position", contactEmployee: "Mitarbeiterkontakt öffnen", callEmployee: "Mitarbeiter anrufen", numberInbox: "Postfach",
    requestNotificationActionable: "Annehmen/Ablehnen in Benachrichtigung", requestNotificationActionableHint: "Für zeitkritische Anfragen (Taxi, Polizei, Rettungsdienst): die Handy-Benachrichtigung bekommt Annehmen/Ablehnen-Knöpfe. Bei anderen Unternehmen wird nur informiert, die App muss dafür geöffnet werden.",
    ...
    unknownNumber: "Unbekannte Nummer", requestLabel: "Anfragebezeichnung", createLabel: "Aktionsbezeichnung", templates: "Vorlagen", back: "Zurück", queuePosition: "Warteschlangenposition", selectNumber: "Telefonnummer auswählen", sendLocation: "Aktuellen Standort senden", locationSent: "Standort gesendet", enabled: "Aktiv", required: "Pflichtfeld", categoryCompetition: "Unternehmensübergreifender Request-Wettbewerb", categoryCompetitionHint: "Verfügbare Mitarbeiter dieser Kategorie konkurrieren um Requests", deleteRequest: "Anfrage löschen", deleteConversation: "Gespräch löschen", deleteMessage: "Nachricht löschen", public: "Öffentlich", numberCapabilitiesHint: "Aktiv ist der Hauptschalter. Öffentlich macht die aktivierten Kanäle für Bürger sichtbar; das Abschalten entfernt nicht das interne Postfach, nur die Sichtbarkeit im Verzeichnis.", staffedLines: "Besetzte Leitungen", navigation: "Navigation bei Annahme", navigationDisabled: "Deaktiviert", navigationAsk: "Mitarbeiter fragen", navigationAutomatic: "Automatisch", activeRequests: "Aktive Anfragen", requestHistory: "Anfrageverlauf", allInboxes: "Alle Postfächer",
    noRequestDetails: "Keine weiteren Angaben übermittelt", createdAt: "Gesendet", navigateToRequest: "Standort setzen",
    statusAccepted: "Angenommen", statusReturned: "Zurückgegeben", statusCancelled: "Storniert", statusDeleted: "Gelöscht",
    requestAction: "Anfrage"
  }
} as const;
...
// The DB/wire status value stays "active" (an accepted, in-progress request) - shown
// as-is that reads like a permanent state, so the UI always displays it as "accepted".
const requestStatusKeys: Record<string, MessageKey> = {
  pending: "pending", active: "statusAccepted", returned: "statusReturned", cancelled: "statusCancelled", deleted: "statusDeleted"
};
export function requestStatusLabel(locale: Locale, status: string) { return t(locale, requestStatusKeys[status] ?? "pending"); }
