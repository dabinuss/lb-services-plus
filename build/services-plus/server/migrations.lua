...
function Migrations.Validate()
    ...
    if (tonumber(version) or 0) < 14 then
        return false, "Database schema is outdated. Apply migrations through sql/migrations/014_request_notification_actionable.sql."
    end
    return true
end
