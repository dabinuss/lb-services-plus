...
The supported callback, event, entity and trusted-resource inventory is maintained in the [API reference](../api/API.md). Do not treat internal Lua modules or Services+ network events as external integration APIs.
